        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user_subscriptions.store') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="basket_choice" class="col-md-4 col-form-label text-md-right">Choix du
                                    panier</label>

                                <div class="col-md-6">
                                    <select class="form-control" id="basket_choice" name="basket_choice">
                                        @foreach($subscription_options as $option)
                                            <option value={{$option->getKey()}}>{{$option->label}} - {{$option->weight}}Kg - {{$option->price}}€</option>
                                        @endforeach
