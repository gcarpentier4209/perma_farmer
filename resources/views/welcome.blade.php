            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4"><span class="fa-stack fa-4x"><i
                        ...
                        <p class="text-muted">Ils sont bons mes melons, ils sont ronds mes potirons, mes tomates sont
                            délicates et mes poireaux sont très beaux.</p>
                    </div>
                    <div class="col-md-4"><span class="fa-stack fa-4x"><i
                                    class="fas fa-circle fa-stack-2x text-primary"></i><i
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        ...
                        <h3 class="section-subheading text-muted">Voici quelques exemples de fruits et légumes que nous
                            proposons. </h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="{{asset('../resources/img/portfolio/01-thumbnail.jpg')}}"
                                 alt="">
                        </a>
                    ...
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="{{asset('../resources/img/portfolio/02-thumbnail.jpg')}}"
                                 alt="">
                        </a>
                        <div class="portfolio-caption">
                            <h4>Carottes</h4>
                    ...
                    <div class="col-md-4 col-sm-6 portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
                            ...
                            <img class="img-fluid" src="{{asset('../resources/img/portfolio/03-thumbnail.jpg')}}"
                                 alt="">
                        </a>
                        <div class="portfolio-caption">
                            <h4>Raisins</h4>
                    ...
                    <div class="col-lg-12">
                        <ul class="timeline">
                            <li>
                                <div class="timeline-image">
                                    <img class="rounded-circle img-fluid"
                                         src="{{asset('../resources/img/about/1.jpg')}}" alt="">
                                </div>
                            ...
                            <li class="timeline-inverted">
                                <div class="timeline-image">
                                    <img class="rounded-circle img-fluid"
                                         src="{{asset('../resources/img/about/2.jpg')}}" alt="">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h4>Mars 2018</h4>
                            ...
                            <li>
                                <div class="timeline-image">
                                    <img class="rounded-circle img-fluid"
                                         src="{{asset('../resources/img/about/3.jpg')}}" alt="">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <a href="#">
                            <img class="img-fluid d-block mx-auto" src="{{asset('../resources/img/logos/envato.jpg')}}"
                                 alt="">
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <a href="#">
                            <img class="img-fluid d-block mx-auto"
                                 src="{{asset('../resources/img/logos/designmodo.jpg')}}" alt="">
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <a href="#">
                            <img class="img-fluid d-block mx-auto"
                                 src="{{asset('../resources/img/logos/themeforest.jpg')}}" alt="">
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <a href="#">
                            <img class="img-fluid d-block mx-auto"
                                 src="{{asset('../resources/img/logos/creative-market.jpg')}}" alt="">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="modal-body">
                                ...
                                <img class="img-fluid d-block mx-auto"
                                     src="{{asset('../resources/img/portfolio/01-thumbnail.jpg')}}" alt="">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem
                                    ...
                                    expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere
                                    nemo!</p>
                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto"
                                     src="{{asset('../resources/img/portfolio/02-thumbnail.jpg')}}" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-fluid d-block mx-auto"
                                     src="{{asset('../resources/img/portfolio/03-thumbnail.jpg')}}" alt="">
                                <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt
                                    repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae,
                                    nostrum, reiciendis facere nemo!</p>
